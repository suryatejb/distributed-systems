...
func TestFailAgree(t *testing.T) {
	...
	fmt.Printf("Test: agreement despite \nfollower disconnection\n")
...
func TestFailNoAgree(t *testing.T) {
	...
	fmt.Printf("Test: no agreement without majority\n")
...
func TestConcurrentPutCommands(t *testing.T) {
	fmt.Printf("==================== 3 SERVERS ====================\n")
	servers := 3
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()

	fmt.Printf("Test: concurrent PutCommand()s\n")
